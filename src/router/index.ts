...
const router = createRouter({
  ...
  routes: [
    { path: '/', component: () => import('../views/Home.vue'), name: 'Home', meta: { requiresAuth: false} },
    { path: '/login', component: () => import('../views/Login.vue'), name: 'Login' },
    { path: '/signup', component: () => import('../views/Signup.vue'), name: 'Signup' },
    { path: '/dashboard', component: () => import('../views/Dashboard.vue'), meta: { requiresAuth: false} },
		{ path: '/analytics', component: () => import('../views/Analytics.vue'), meta: { requiresAuth: false} },
