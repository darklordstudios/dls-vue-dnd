...
export default {
  ...
  mounted() {
    axios
      .get("/assets/data/ui/modal-notification-code-1.json")
      .then((response) => {
        this.code1 = response.data;
      });
    axios
      .get("/assets/data/ui/modal-notification-code-2.json")
      .then((response) => {
        this.code2 = response.data;
      });
    axios
      .get("/assets/data/ui/modal-notification-code-3.json")
      .then((response) => {
        this.code3 = response.data;
      });
    axios
      .get("/assets/data/ui/modal-notification-code-4.json")
      .then((response) => {
        this.code4 = response.data;
      });
    axios
      .get("/assets/data/ui/modal-notification-code-5.json")
      .then((response) => {
        ...
        <div class="row">
          ...
          <div class="col-xl-9">
            ...
            <div id="modalCover" class="mb-5">
              ...
              <p>
                ...
                provide the same background color as the modal content. Place a
                <code>.modal-cover</code> css class on <code>.modal</code> for
                full cover modal.
              </p>
              <card>
                <card-body>
            ...
            <div id="toastsNotification" class="mb-5">
              ...
              <p>
                ...
                and easily customizable alert message. Please read the
                <a
            ...
            <div id="toastsContainer" class="mb-5">
              ...
              <p>
                Toasts container is an extended ui from Bootstrap toasts. Wrap
                the toasts with <code>.toasts-container</code> will allow toast
                to float within the right top position.
              </p>
              <card>
                <card-body>
                  <a
                    href="#"
                    class="btn btn-outline-theme me-2"
                    @click="(event) => showToast(event, 'toast-1')"
                    >Show toast 1</a
                  >
                  <a
                    href="#"
                    class="btn btn-outline-theme"
                    @click="(event) => showToast(event, 'toast-2')"
                    >Show toast 2</a
                  >
                </card-body>
          ...
          <div class="col-xl-3">
            ...
            <nav
              ...
              class="navbar navbar-sticky d-none d-xl-block"
            >
              <nav class="nav">
                <nav-scroll-to target="#modal" data-toggle="scroll-to"
                  >Modal</nav-scroll-to
                >
                <nav-scroll-to target="#modalSizes" data-toggle="scroll-to"
                  >Modal Sizes</nav-scroll-to
                >
                <nav-scroll-to target="#modalCover" data-toggle="scroll-to"
                  >Modal Cover</nav-scroll-to
                >
                <nav-scroll-to
                  target="#toastsNotification"
                  data-toggle="scroll-to"
                  >Toasts Notification</nav-scroll-to
                >
                <nav-scroll-to target="#toastsContainer" data-toggle="scroll-to"
                  >Toasts Container</nav-scroll-to
                >
              </nav>
            </nav>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="pt-3">
            <a href="#" class="text-muted fs-12px"
              >What is it? Terms and conditions</a
            >
          </div>
        </div>
      </div>
