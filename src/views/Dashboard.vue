...
export default {
  ...
  methods: {
      ...
      return [
        {
          ...
          info: [
            ...
            { icon: "far fa-user fa-fw me-1", text: "45.5% new visitors" },
            {
        ...
        },
        {
          ...
          info: [
            ...
            { icon: "fa fa-shopping-bag fa-fw me-1", text: "33.5% new orders" },
            {
        ...
        },
        {
          ...
          info: [
            ...
            { icon: "fab fa-youtube fa-fw me-1", text: "15.25% from youtube" },
          ],
          chart: {
            height: 45,
            options: {
        ...
        },
        {
          ...
          info: [
            ...
            { icon: "far fa-hdd fa-fw me-1", text: "10.5% from total usage" },
            { icon: "far fa-hand-point-up fa-fw me-1", text: "2MB per visit" },
          ],
          chart: {
            height: 45,
            options: {
    ...
    getServerData() {
      ...
      return {
        chart: {
          ...
          options: {
            colors: [
              "rgba(" + appVariable.color.inverseRgb + ", .25)",
    ...
    getProductsData() {
      return [
        {
          img: "/assets/img/dashboard/product-1.jpeg",
          sku: "SKU90400",
        ...
        {
          img: "/assets/img/dashboard/product-2.jpeg",
          sku: "SKU85999",
        ...
        {
          img: "/assets/img/dashboard/product-3.jpeg",
          sku: "SKU20400",
        ...
        {
          img: "/assets/img/dashboard/product-4.jpeg",
          sku: "SKU19299",
        ...
        {
          img: "/assets/img/dashboard/product-5.jpeg",
          sku: "SKU19299",
                ...
                <div class="ps-3 flex-1">
                  ...
                  <div class="progress h-3px mb-1">
                    <div
                      ...
                      v-bind:style="{ width: stat.progress }"
                    ></div>
                  </div>
          ...
          <div class="row gx-4">
            <div class="col-lg-6 mb-3 mb-lg-0">
              <table class="w-100 small mb-0 text-truncate text-inverse text-opacity-60">
                ...
                <tbody>
                  <tr
                    v-if="traffic.country"
                    v-for="country in traffic.country"
                ...
                <tr v-if="activityLog" v-for="log in activityLog">
                  <td>
                    <span class="d-flex align-items-center">
                      <i
                        class="bi bi-circle-fill fs-6px me-2"
                        v-bind:class="{ 'text-theme': log.highlight }"
                      ></i>
                      {{ log.title }}
                    </span>
                  </td>
                  ...
                  <td>
                    <span
                      ...
                      v-bind:class="{
                        'bg-theme text-theme-900': log.highlight,
                        'bg-inverse bg-opacity-25': !log.highlight,
                      }"
