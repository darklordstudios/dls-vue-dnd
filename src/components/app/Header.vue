...
let isAuthenticated = authStore.isAuthenticated ? true : false
let user = null
if (isAuthenticated) {
  user = authStore.user
}
		...
		<div class="menu">
			...
			<div class="menu-item dropdown dropdown-mobile-full">
				<a href="#" data-bs-toggle="dropdown" data-bs-display="static" class="menu-link">
					...
					<div v-if="isAuthenticated" class="menu-text d-sm-block d-none w-170px">{{ user.email }}</div>
          <div v-else class="menu-text d-sm-block d-none w-170px">username@account.com</div>
				</a>
